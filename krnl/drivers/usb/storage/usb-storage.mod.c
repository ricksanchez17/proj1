...
__used __section("__versions") = {
	...
	{ 0xa3ff52a5, "_dev_err" },
	{ 0x512b47db, "sg_miter_next" },
	{ 0xfe487975, "init_wait_entry" },
	{ 0x416f2eb, "device_create_file" },
	{ 0x800473f, "__cond_resched" },
	{ 0x34ea72ab, "blk_queue_bounce_limit" },
	...
	{ 0x1000e51, "schedule" },
	{ 0x20d6274c, "usb_sg_cancel" },
	{ 0xf02aa937, "wait_for_completion_interruptible_timeout" },
	{ 0x93c7edeb, "usb_find_common_endpoints" },
	{ 0x5e2d7875, "cpu_hwcap_keys" },
	{ 0x47bbfdf3, "wake_up_process" },
	{ 0xb497f4fe, "scsi_eh_prep_cmnd" },
	...
	{ 0xf57689dc, "scsi_report_device_reset" },
	{ 0xb1befefe, "usb_alloc_urb" },
};

MODULE_INFO(depends, "scsi_mod,scsi_common,usbcore");
