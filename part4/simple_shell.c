...
int main(int argc, char **argv)
{
    ...
    than 1 then it must display an error message to stderr stating that arguments 
	are not supported, then reprompt user again, otherwise call the user_prompt_loop()
	function to get user input repeatedly until the user enters the "exit" command.
    */
