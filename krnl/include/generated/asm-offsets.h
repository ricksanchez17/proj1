...
#define TSK_ACTIVE_MM 1096 /* offsetof(struct task_struct, active_mm) */
...
#define TSK_STACK_CANARY 1280 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 2800 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 3872 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 3768 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 3848 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 3864 /* offsetof(struct task_struct, thread.mte_ctrl) */
...
#define VCPU_FAULT_DISR 2160 /* offsetof(struct kvm_vcpu, arch.fault.disr_el1) */
#define VCPU_WORKAROUND_FLAGS 2168 /* offsetof(struct kvm_vcpu, arch.workaround_flags) */
#define VCPU_HCR_EL2 2104 /* offsetof(struct kvm_vcpu, arch.hcr_el2) */
#define CPU_USER_PT_REGS 0 /* offsetof(struct kvm_cpu_context, regs) */
#define CPU_RGSR_EL1 1744 /* offsetof(struct kvm_cpu_context, sys_regs[RGSR_EL1]) */
#define CPU_GCR_EL1 1752 /* offsetof(struct kvm_cpu_context, sys_regs[GCR_EL1]) */
#define CPU_APIAKEYLO_EL1 1600 /* offsetof(struct kvm_cpu_context, sys_regs[APIAKEYLO_EL1]) */
#define CPU_APIBKEYLO_EL1 1616 /* offsetof(struct kvm_cpu_context, sys_regs[APIBKEYLO_EL1]) */
#define CPU_APDAKEYLO_EL1 1632 /* offsetof(struct kvm_cpu_context, sys_regs[APDAKEYLO_EL1]) */
#define CPU_APDBKEYLO_EL1 1648 /* offsetof(struct kvm_cpu_context, sys_regs[APDBKEYLO_EL1]) */
#define CPU_APGAKEYLO_EL1 1664 /* offsetof(struct kvm_cpu_context, sys_regs[APGAKEYLO_EL1]) */
#define HOST_CONTEXT_VCPU 1808 /* offsetof(struct kvm_cpu_context, __hyp_running_vcpu) */
...
#define TRAMP_VALIAS -4398084288512 /* TRAMP_VALIAS */
