cmd_vmlinux := sh scripts/link-vmlinux.sh "ld" "-EL  -maarch64elf -z noexecstack" "--no-undefined -X -shared -Bsymbolic -z notext  --no-apply-dynamic-relocs --fix-cortex-a53-843419 --build-id=sha1  -X --orphan-handling=warn";  true
